...
public class CartService {
    ...
    public void addCart(Cart cart) {
        ...
        /* ======================================================================================================== *
                                                        先查询
         * ======================================================================================================== */
        BoundHashOperations<String, Object, Object> hashOperations = stringRedisTemplate.boundHashOps(userInfo.getId().toString());
    ...
    public List<Cart> queryCarts() {
        ...
        /* ======================================================================================================== *
                                                 判断hash操作对象是否存在
         * ======================================================================================================== */
        if (!stringRedisTemplate.hasKey(userInfo.getId().toString())) {
            return null;
        }
